...
DROP TABLE IF EXISTS `opdrachtgevers`;
...
CREATE TABLE `opdrachtgevers` (
  ...
  CONSTRAINT `opdrachtgevers_ibfk_1` FOREIGN KEY (`gebruiker_id`) REFERENCES `gebruikers` (`gebruiker_id`)
...
LOCK TABLES `opdrachtgevers` WRITE;
