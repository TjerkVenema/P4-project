...
INSERT INTO `opdrachten` VALUES (1,36,'backend junior programmeur','wij zoken een junior back end programmeur voor ons bedrijf','HBO','beschikbaar','product','website','1','2021-06-30','2022-06-24'),(2,37,'front end junior programmeur','wij zoeken een front end junior programmeur','HBO','beschikbaar','product','website','1','2021-06-09','2021-06-25'),(3,38,'trouble shoot sessie bank app','wij zoeken een student die ons kan het helpen met het trouble shooten van onze bank app','HBO','beschikbaar','anders','procesverbetering','2','2021-07-06','2021-07-13'),(4,38,'security problemen webportaal','security problemen van ons webpoortaal proberen vast te stellem','MBO','beschikbaar','advies','website','2','2021-08-16','2021-08-19'),(5,38,'whitehat hacking ','white hacker gezocht voor het onderzoeken van onze applicatie','HBO','beschikbaar','advies','gegevensbewerking','2','2021-09-14','2021-09-18'),(6,37,'training datalek','wij zoeken een student om een simulatie voor het dichten van een datalek mee te oefenen','MBO','beschikbaar','anders','security','3','2021-06-26','2021-06-30'),(7,36,'code review','wij willen een HBO student hebben die de code van onze app na kan lopen en kan controleren op bugs','HBO','bezig','advies','security','3','2021-06-16','2021-06-22');
...
-- Dump completed on 2021-06-17 15:32:47
